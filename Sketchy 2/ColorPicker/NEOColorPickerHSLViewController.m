...
- (void)viewDidLoad {
    ...
    self.gradientViewSaturation.layer.cornerRadius = 10.0;
    self.gradientViewSaturation.layer.borderColor = [UIColor darkGrayColor].CGColor;
    self.gradientViewSaturation.layer.borderWidth = 1.0;
    ...
    self.gradientViewLuminosity.layer.cornerRadius = 10.0;
    self.gradientViewLuminosity.layer.borderColor = [UIColor darkGrayColor].CGColor;
    self.gradientViewLuminosity.layer.borderWidth = 1.0;
    ...
    self.gradientViewAlpha.layer.cornerRadius = 10.0;
    self.gradientViewAlpha.layer.borderColor = [UIColor darkGrayColor].CGColor;
    self.gradientViewAlpha.layer.borderWidth = 1.0;
...
- (void) positionHue {
    ...
    CGFloat cx = 65 * cos(angle) + 160 - 16.5;
    CGFloat cy = 65 * sin(angle) + 90 + self.hueImageView.frame.origin.y - 16.5;
...
- (void) valuesChanged {
    ...
    self.selectedColor = [UIColor colorWithHue:_hue saturation:_saturation brightness:_luminosity alpha:1];
    _colorLayer.backgroundColor = self.selectedColor.CGColor;
    [_colorLayer setNeedsDisplay];
